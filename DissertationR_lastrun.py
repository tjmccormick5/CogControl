...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/TimothyMcCormick/Desktop/SPR/Selfpaced reading/DissertationR.psyexp',
...
spacetoContinue = visual.TextStim(win=win, name='spacetoContinue',
    text=u"Pulsa 'espacio' para continuar.",
    font=u'courier',
...
for thisRepeatPracticeSentencesIfNeeded in RepeatPracticeSentencesIfNeeded:
    ...
    for thisPracticeSentenceLoop in practiceSentenceLoop:
        ...
        while continueRoutine:
            ...
            if t >= 0.2 and key_resp_practiceCompQ.status == NOT_STARTED:
                # keep track of start time/frame for later
