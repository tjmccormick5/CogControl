...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy3 Experiment Builder (v1.90.1),
    on Fri Sep  7 15:31:03 2018
...
expInfo = {'participant': '', 'session': '', 'group': '', 'level': ''}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/TimothyMcCormick/Desktop/SPR/Selfpaced reading/DissertationSpanish.py',
...
introText = visual.TextStim(win=win, name='introText',
    text="Gracias por participar en este estudio. Consideramos tu comprensión y procesamiento del castellano. \n\nAntes de empezar, es importante saber que la exactitud y la rapidez serán importantes a lo largo del estudio.\n\nEs decir, para terminar el estudio en el periodo más breve posible, tendrás que aplicarte y concentrarte.  \n\nCuando estés list@, pulsa 'espacio' para continuar.",
    font='courier',
...
Intro2text = visual.TextStim(win=win, name='Intro2text',
    text='A lo largo del experimento, verás dos tipos de estimulos:  \n\nEn el primero, se te presentará una imágen con flechas en el centro de la pantalla. Tu tarea es indicar la dirección de la flecha en el medio.\n\nEn el segundo, verás una oración tapada con guiones ("-"). Destaparás cada palabra, de una en una, para leer la oración. Luego, responderás a una pregunta sobre la oración.\n\nPulsa \'espacio\' para continuar.',
    font='courier',
    pos=(0, 0), height=0.075, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
FlankerInstructions = visual.TextStim(win=win, name='FlankerInstructions',
    text="Primero, vamos a practicar qué hacer con los estimulos de flechas. \n\nVerás imágenes o bien con una flecha o con cinco. A veces, las 5 flechas miran hacia el mismo lado, a veces no. \nSea lo que sea, tu tarea es indicar la dirección de la flecha en el medio. \n\nSi la flecha en el medio mira a la izquierda, pulsa 'f'.\nSi la flecha en el medio mira a la derecha, pulsa 'j'.\n\nPulsa 'espacio' para continuar.\n",
    font='courier',
    pos=(0, 0), height=0.075, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
flankerInstructions2 = visual.TextStim(win=win, name='flankerInstructions2',
    text="Recuerda: tanto la exactitud como la rapidez son importantes.\n\nSi respondes muy lento o eliges la dirección equivocada, el programa considerará esa respuesta incorrecta.\n\nTendrás que repetir la práctica si no alcanzas una exactitud de por lo menos 80%.\n\nPulsa 'espacio' cuando estés list@ para completar la práctica.",
    font='courier',
    pos=(0, 0), height=0.075, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
SPRInstructions = visual.TextStim(win=win, name='SPRInstructions',
    text="¡Muy bien! Has dominado la tarea de las flechas.\n\nAhora, vamos a probar la tarea de oraciones. Recuerda: las palabras estarán tapadas por guiones.\n\nPara destapar la primera palabra (y cada palabra que la sigue), pulsas 'espacio'.\n\nPara continuar, pulsa 'espacio'.\n\n",
    font='courier',
    pos=(0, 0), height=0.075, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
text_2 = visual.TextStim(win=win, name='text_2',
    text='Algunas de las oraciones y preguntas son fuera de contexto o no suenan perfectamente naturales. No pasa nada. Haz lo que puedas para responder a la pregunta.\n\nLas preguntas son de estilo "Verdadero/Falso".\n\nPara responder \'Verdadero\', pulsa \'f\'.\nPara responder \'Falso\', pulsa \'j\'.\n\nNo tienes que memorizar las teclas, porque siempre verás las palabras en la pantalla para recordarte.\n\nPara continuar a la práctica, pulsa \'espacio\'.',
    font='courier',
    pos=(0, 0), height=0.075, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
SPRinstructions2 = visual.TextStim(win=win, name='SPRinstructions2',
    text="Recuerda: tanto la exactitud como la rapidez son importantes.\n\nSi respondes muy lento o eliges la respuesta equivocada, el programa considerará esa respuesta incorrecta.\n\nTendrás que repetir la práctica si no alcanzas una exactitud de por lo menos 80%.\n\nPulsa 'espacio' cuando estés list@ para completar la práctica.",
    font='courier',
    pos=(0, 0), height=0.075, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
Instructions_Combined = visual.TextStim(win=win, name='Instructions_Combined',
    text="¡Excelente! Ahora, por el resto del experimento, los dos tipos de estimulos estarán mezclados.\n\nSi tienes preguntas durante el estudio, no dudes en preguntarle al investigador.\n\nPulsa 'espacio' para continuar.",
    font='Courier',
    pos=(0, 0), height=0.075, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
