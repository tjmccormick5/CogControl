...
FlankerInstructions = visual.TextStim(win=win, name='FlankerInstructions',
    text="Full flanker instructions\n\nPress 'space' to continue.\n",
    font='courier',
...
SPRInstructions = visual.TextStim(win=win, name='SPRInstructions',
    text="Full Instructions for SPR\n\nPress 'space' to continue.\n\n",
    font='courier',
    pos=(0, 0), height=0.1, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1,
    depth=0.0);
...
SPRinstructions2 = visual.TextStim(win=win, name='SPRinstructions2',
    text="Remember that you need to respond to the questions \nat least 80% correct to continue \n\nPress 'space' when you're ready to continue",
    font='courier',
...
Instructions_Combined = visual.TextStim(win=win, name='Instructions_Combined',
    text="Now you'll do both SPR and flanker\n\nPress 'space' to continue.",
    font='Courier',
    pos=(0, 0), height=0.1, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1,
    depth=0.0);
...
PressSpaceToContinue = visual.TextStim(win=win, name='PressSpaceToContinue',
    ...
    font=u'courier',
    pos=(0, -.75), height=0.04, wrapWidth=None, ori=0, 
    color=u'black', colorSpace='rgb', opacity=1,
    depth=-2.0);
